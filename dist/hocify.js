  ...
  return () => {
    ...
    const setComponentProps = (name, props, component) => {
      setState(prev => {
        ...
        const newState = { ...prev,
          [name]: { ...prev[name],
            [component]: { ...prev[name][component],
              props: { ...prev[name][component].props,
                ...props
              }
            }
          }
        ...
        return { ...prev,
          ...
          [name]: { ...prev[name],
            before: { ...prev[name].before,
              ...
              props: { ...before.props(props => setBeforeProps(name, props), prev[name].data, prev[name].errors),
                confirmFn,
                denyFn
              },
              resolvers,
    ...
    const performBeforeAction = async ({
      name,
      before
    }) => {
      setState(prev => {
    ...
    useEffect(() => {
      hocInfos.forEach(({
        ...
        if (state.beforeReady && state.beforeReady[name] && state.beforeReady[name].ready) {
          performBeforeAction({
            name,
            before
          });
